...
const page = async ({ params }) => {
    ...
    const article = await getBlog(params.id)
 ...
 <p class="mb-3 font-light text-gray-500 dark:text-gray-400 first-line:uppercase first-line:tracking-widest first-letter:text-7xl first-letter:font-bold first-letter:text-gray-900 dark:first-letter:text-gray-100 first-letter:mr-3 first-letter:float-left">{article?.article_message}</p>
                    <p class="font-light text-gray-500 dark:text-gray-400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus rerum harum, obcaecati vitae culpa placeat eius modi illum, quas possimus, neque nihil repellat. Necessitatibus, corporis dicta dignissimos exercitationem nobis excepturi.
                    ...
                    <p class="font-light text-gray-500 dark:text-gray-400 mt-2">Dignissimos quas, harum illum magnam similique expedita, perferendis voluptas reprehenderit eaque sed architecto tenetur ratione repellat modi rerum distinctio officia obcaecati sapiente id reiciendis quae aliquid eum. Beatae, aspernatur ex!

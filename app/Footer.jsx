...
const Footer = () => {
  return (    
    <div className="w-screen mt-20">
        <footer className="p-4 bg-gradient-to-r from-blue-500 via-pink-500 to-pink-300">
            <div className="md:flex md:justify-between">
                <div className="mb-6 md:mb-0">
                    <a href="/" className="flex items-center">
                    <img 
                        src="https://img.icons8.com/dusk/64/000000/sound-recording-copyright.png"
                        className="h-12 mr-3"
                        alt="logo"
                    />
                        <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Prismly Blogs</span>
                    </a>
                </div>
                <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        <h2 className="mb-6 text-sm font-semibold uppercase text-blue-400">Resources</h2>
                        <ul className="text-gray-300">
                            <li className="mb-4">
                                <a href="https://supabase.com/" className="hover:underline">Supabse</a>
                            </li>
                            <li>
                    ...
                    <div>
                        <h2 className="mb-6 text-sm font-semibold uppercase text-blue-400">Follow us</h2>
                        <ul className="text-gray-300">
                            <li className="mb-4">
                                <a href="https://github.com/masonrs2" className="hover:underline ">Github</a>
                            </li>
                            <li>
                    ...
                    <div>
                        <h2 className="mb-6 text-sm font-semibold uppercase text-blue-400">Legal</h2>
                        <ul className="text-gray-300">
                            <li className="mb-4">
            ...
            <hr className="my-6 border-gray-200 sm:mx-auto text-gray-300 lg:my-8" />
            <div className="sm:flex sm:items-center sm:justify-between">
                <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <Link href="/" className="hover:underline">Prismly Blogs</Link>. All Rights Reserved.
                </span>
                <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                    <a href="https://www.facebook.com/mason.sepulveda5/" className="text-gray-200 hover:text-gray-300">
                    ...
                    <a href="https://www.masonsepulveda.net" className="text-gray-200 hover:text-gray-300">
                    ...
                    <a href="https://www.twitter.com" className="text-gray-200 hover:text-gray-300 ">
                    ...
                    <a href="https://www.dribbble.com" className="text-gray-200 hover:text-gray-300">
